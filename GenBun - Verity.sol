...
contract GenBunVerity is Ownable, ERC721Burnable, ERC721Pausable, ERC721Enumerable{
    ...
    constructor(string memory baseUri, address _signer, IERC20 _token) ERC721("GenBun: Verity", "GENBUN-V"){
        setBaseUri(baseUri);
        pause(true);
        signer = _signer;
        token = _token;
